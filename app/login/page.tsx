        ...
        <div className="relative border border-white/[0.07] bg-[#0d1424]/95 p-6 backdrop-blur-xl sm:p-8">
          ...
          <div className="flex flex-col gap-2.5">
            <Button onClick={handleGoogleLogin} variant="glass" size="lg" className="w-full justify-center rounded-lg group">
              <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true"><path fill="#4285F4" d="M21.35 12.27c0-.7-.06-1.37-.18-2H12v3.79h5.24a4.48 4.48 0 0 1-1.94 2.94v2.45h3.14c1.84-1.7 2.91-4.2 2.91-7.18Z"/><path fill="#34A853" d="M12 21.7c2.63 0 4.84-.87 6.45-2.35l-3.14-2.45c-.87.58-1.98.92-3.31.92-2.54 0-4.69-1.72-5.46-4.03H3.3v2.53A9.75 9.75 0 0 0 12 21.7Z"/><path fill="#FBBC05" d="M6.54 13.79A5.86 5.86 0 0 1 6.24 12c0-.62.11-1.22.3-1.79V7.68H3.3A9.73 9.73 0 0 0 2.25 12c0 1.57.38 3.05 1.05 4.32l3.24-2.53Z"/><path fill="#EA4335" d="M12 6.18c1.43 0 2.71.49 3.72 1.45l2.79-2.79C16.84 3.28 14.63 2.3 12 2.3a9.75 9.75 0 0 0-8.7 5.38l3.24 2.53c.77-2.31 2.92-4.03 5.46-4.03Z"/></svg>
